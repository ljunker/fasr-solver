...
public class FormationTemplates {
  ...
  public static FasrGraph Lines() {
    ...
    graph.addVertex(G3);
    graph.addVertex(G4);
    graph.addEdge(B1, G1, new HandConnection<>(B1, RightHand.class, G1, LeftHand.class));
    graph.addEdge(B2, G2, new HandConnection<>(B2, RightHand.class, G2, LeftHand.class));
    graph.addEdge(B3, G3, new HandConnection<>(B3, RightHand.class, G3, LeftHand.class));
    graph.addEdge(B4, G4, new HandConnection<>(B4, RightHand.class, G4, LeftHand.class));
    graph.addEdge(G1, B2, new HandConnection<>(G1, RightHand.class, B2, LeftHand.class));
    graph.addEdge(G3, B4, new HandConnection<>(G3, RightHand.class, B4, LeftHand.class));
  ...
  public static FasrGraph LinesTwoCouplesTraded() {
    ...
    graph.addEdge(B3, G3, new HandConnection<>(B3, RightHand.class, G3, LeftHand.class));
    graph.addEdge(B4, G4, new HandConnection<>(B4, RightHand.class, G4, LeftHand.class));
    graph.addEdge(G2, B1, new HandConnection<>(G2, RightHand.class, B1, LeftHand.class));
    graph.addEdge(G3, B4, new HandConnection<>(G3, RightHand.class, B4, LeftHand.class));
  ...
  public static FasrGraph RightHandedTwoFacedLines() {
    ...
    graph.addEdge(B3, G3, new HandConnection<>(B3, RightHand.class, G3, LeftHand.class));
    graph.addEdge(B4, G4, new HandConnection<>(B4, RightHand.class, G4, LeftHand.class));
    graph.addEdge(G1, G2, new HandConnection<>(G1, RightHand.class, G2, RightHand.class));
    graph.addEdge(G3, G4, new HandConnection<>(G3, RightHand.class, G4, RightHand.class));
